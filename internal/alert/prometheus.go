...
func (c *PrometheusCollector) Describe(ch chan<- *prometheus.Desc) {
	...
	c.metrics.NamespaceAccess.Describe(ch)
	c.metrics.SuspiciousOutbound.Describe(ch)
...
func (c *PrometheusCollector) Collect(ch chan<- prometheus.Metric) {
	...
	c.metrics.NamespaceAccess.Collect(ch)
	c.metrics.SuspiciousOutbound.Collect(ch)
